...
public class UsersAndGroupsSearchProvider extends ContentProvider {
     ...
     *
     * @param uri           Content {@link Uri}, formatted as "content://com.zeuscloud.android.providers.UsersAndGroupsSearchProvider/"
                    ...
                    switch (type) {
                        ...
                        case USER:
                            ...
                            subline = (status.getMessage() == null || status.getMessage().isEmpty()) ? null :
                                status.getMessage();
                            Uri.Builder builder =
                                Uri.parse("content://com.zeuscloud.android.providers.UsersAndGroupsSearchProvider/icon")
                                    .buildUpon();
