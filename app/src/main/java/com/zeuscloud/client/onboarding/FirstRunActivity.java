...
package com.zeuscloud.client.onboarding;
...
import com.owncloud.android.ui.zeus.CustomFeaturesViewAdapter;
...
//        ArrayList<Integer> slideLayouts = new ArrayList<>();
//        slideLayouts.add(R.layout.custom_first_slide);
////      slideLayouts.add(R.layout.custom_second_slide);
////      slideLayouts.add(R.layout.custom_third_slide);
////      slideLayouts.add(R.layout.custom_fourth_slide);
//
//
//        CustomFeaturesViewAdapter featuresViewAdapter = new CustomFeaturesViewAdapter(getSupportFragmentManager(), slideLayouts);
//        binding.progressIndicator.setNumberOfSteps(featuresViewAdapter.getCount());
//        binding.contentPanel.setAdapter(featuresViewAdapter);
//
//        binding.contentPanel.addOnPageChangeListener(this);
...
//            new FeatureItem(R.drawable.whitebg__1_, R.string.first_run_1_text, R.string.empty, true, false),
